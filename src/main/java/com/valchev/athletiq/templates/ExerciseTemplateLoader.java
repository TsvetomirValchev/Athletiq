...
public class ExerciseTemplateLoader implements ApplicationRunner {
    ...
    private List<ExerciseTemplate> createExerciseTemplates() {
        ...
        templates.add(createTemplate(
                ...
                Arrays.asList("Upper Chest", "Shoulders", "Triceps"),
        ...
        templates.add(createTemplate(
                ...
                Arrays.asList("Lower Back", "Hamstrings", "Glutes", "Traps"),
        ...
        templates.add(createTemplate(
                ...
                Arrays.asList("Lats", "Biceps", "Mid-Back"),
        ...
        templates.add(createTemplate(
                ...
                Arrays.asList("Mid-Back", "Lats", "Biceps", "Rear Delts"),
        ...
        templates.add(createTemplate(
                ...
                Arrays.asList("Quadriceps", "Glutes", "Hamstrings", "Lower Back"),
        ...
        templates.add(createTemplate(
                ...
                Arrays.asList("Hamstrings", "Glutes", "Lower Back"),
