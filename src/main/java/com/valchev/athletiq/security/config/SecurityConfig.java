...
public class SecurityConfig {
    ...
    private final AthletiqJwtConverter athletiqJwtConverter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/workouts/**", "/active-workouts/**", "/exercise-templates/**", "/statistics/**, /auth/validate-token").authenticated()
                        .anyRequest().authenticated()
                )
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                .oauth2ResourceServer(oauth2 -> oauth2
                        .jwt(jwt -> jwt.jwtAuthenticationConverter(athletiqJwtConverter))
